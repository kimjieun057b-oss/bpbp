...
export default function PrevNextNavbar2({
    ...
    return (
        <div className="flex gap-4">
            ...
            <Link
                href={prevItem.href}
                className="group flex-1 bg-white rounded-lg border border-gray-200 p-5 flex flex-col gap-3 hover:border-primary transition-colors"
            >
            ...
            <Link
                href={nextItem.href}
                className="group flex-1 bg-white rounded-lg border border-gray-200 p-5 flex flex-col items-end gap-3 hover:border-primary transition-colors"
            >
                <span className="text-sm text-muted group-hover:text-primary transition-colors">
                    {nextLabel}
                </span>
